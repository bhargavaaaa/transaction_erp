            ...
            <div class="block-header block-header-default">
                <div class="row w-100">
                    ...
                    <div class="col text-end">
                        {!! getCreateButton("javascript:;", "Import", "import mb-1", "data-bs-toggle='modal' data-bs-target='#import_model'", "other-modify") !!}
                    </div>
                </div>
            </div>
            <div class="block-content block-content-full">
                <form action="{{ route('other.create') }}" method="POST" id="transaction_form"
