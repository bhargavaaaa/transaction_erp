            ...
            <div class="block-header block-header-default">
                <div class="row w-100">
                    ...
                    <div class="col text-end">
                        {!! getCreateButton("javascript:;", "Import", "import mb-1", "data-bs-toggle='modal' data-bs-target='#import_model'", "cutting-modify") !!}
                    </div>
                </div>
            </div>
            <div class="block-content block-content-full">
                <form action="{{ route('cutting.create') }}" method="POST" id="transaction_form"
        ...
        $(function() {
            ...
            $(document).on('submit', '#import_form', function (e) {
                ...
                if (!isLoading) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `{{ route('cutting.import.store') }}`,
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
